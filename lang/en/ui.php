...
return [
    ...
    'home' => [
        ...
        'fsiot_body' => 'A comprehensive 73-module curriculum from scratch is being prepared: from DC electronics, ESP32 C++, MQTT, Python backend, PWA dashboards, to Raspberry Pi Linux. Free to read at launch.',
    ...
    'about' => [
        ...
        'fsiot_body' => 'We are preparing Full Stack IoT Developer — From Zero: a 73-module comprehensive curriculum from basic electronics to 24/7 edge servers. The path page currently shows Coming soon; lessons open sequentially.',
        'fsiot_cta' => 'Check path status →',
    ...
    'fsiot' => [
        ...
        'meta_description' => 'Koding Indonesia’s featured path: learn Full Stack IoT from absolute beginner to hero — free, sequential, 73 comprehensive modules. Support us via Trakteer.',
        'meta_og_title' => 'Full Stack IoT Developer — From Zero',
        'meta_og_description' => 'A comprehensive 73-module curriculum (free access) from physical sensors to dashboards and Raspberry Pi edge gateways.',
        'breadcrumb_learn' => 'Learn',
        'badge' => 'Featured path · free access',
        'title' => 'Full Stack IoT Developer',
        'intro' => 'A curriculum from absolute zero to building industry-grade IoT systems: from low-voltage DC electronics and memory-efficient C++ on ESP32-DevKitC-1 to MQTT protocols, SQLite/MariaDB, Python Flask & WebSockets, mobile PWA dashboards, and 24/7 Linux edge gateways on Raspberry Pi with Docker.',
        'soon_meta_title' => 'Full Stack IoT Developer — Coming Soon | Koding Indonesia',
        'soon_meta_description' => 'Koding Indonesia’s Full Stack IoT path is being rebuilt from scratch: 73 detailed modules, hybrid ESP32 & Raspberry Pi architecture. Subscribe to the newsletter to hear when it opens.',
        'soon_meta_og_title' => 'Full Stack IoT — Coming Soon',
        'soon_meta_og_description' => 'A 73-module curriculum from scratch is being prepared. Coming soon — free to read at launch.',
        'soon_badge' => 'Coming soon',
        'soon_headline' => 'The Full Stack IoT learning path is being prepared carefully from scratch.',
        'soon_body' => 'A master curriculum of 73 modules across 6 integrated learning phases: from electronics foundations and C++ on ESP32 to MQTT networking, Python backend, mobile PWA dashboards, and 24/7 Linux servers on Raspberry Pi. Bookmark this page or subscribe to our newsletter to hear when modules launch.',
        'soon_board_title' => 'Hardware & Learning Approach',
        'soon_board_body' => 'An inclusive hybrid architecture: An ESP32-DevKitC-1 board (~$4) and your everyday laptop are enough to finish 100% of the lessons. An optional Super-Upgrade track is provided for Raspberry Pi (or cheap repurposed Linux TV boxes).',
        'soon_newsletter' => 'Notify me when it opens',
        'soon_support_body' => 'While the path is being prepared, you can support Koding Indonesia with a tip on Trakteer — for server costs, hardware components, and writing time.',
        'soon_roadmap_title' => '6-Phase Curriculum Overview (73 Modules)',
        ...
        'stat_modules' => 'Detailed modules',
        'stat_modules_hint' => '6 integrated phases',
        'stat_lang' => 'Language & Standards',
        'stat_lang_value' => 'ID + EN',
        'stat_lang_hint' => 'beginner & industry ready',
        'stat_cost' => 'Access cost',
        'stat_cost_value' => 'Free',
        'stat_cost_hint' => 'starter kit ~$12',
        'thread_title' => 'Anchor Project: Study Room Station',
        'thread_body' => 'The entire curriculum revolves around one real-world project: building an intelligent Study Room Station — monitoring precision temperature (BME280) and ambient light (LDR), safe relay load control with hysteresis, offline MicroSD buffer, Python SQLite/MariaDB backend, live WebSockets, mobile PWA, two-way Telegram alerts, and 24/7 Linux edge computing on Raspberry Pi.',
        'thread_status' => 'Modules publish sequentially, starting from Modul M-01 (#71: Entryway to IoT). Bookmark this page as the official path portal.',
        'phases_title' => 'Six Learning Phases (73 Modules)',
        'support_title' => 'Support Koding Indonesia',
        'support_body' => 'This path is free to read at launch. If our curriculum helps you, you can support us with a tip on Trakteer — for server costs, hardware testing kits, and writing time.',
        ...
        'phases' => [
            'babak1' => [
                'title' => 'Electronics Foundations, Hardware, Pinout & C++ Programming',
                'blurb' => 'Safe DC electricity, multimeters, breadboards, Ohm’s law, brownout & ground protection, strapping pins, RAM-efficient C++, PWM, BME280/LDR sensors, relay hysteresis, OLED, and NVS flash preferences.',
            ],
            'babak2' => [
                'title' => 'Networking, Connectivity, Multitasking & MQTT Protocol',
                'blurb' => 'Wi-Fi STA auto-reconnect, WiFiManager captive portal, NTP clock sync, FreeRTOS dual-core multitasking, MQTT Mosquitto architecture, JSON telemetry, MQTT LWT & Retain, and MicroSD buffer.',
            ],
            'babak3' => [
                'title' => 'Data Engine, SQL Aggregation & Backend Server on Laptop',
                'blurb' => 'Python venv/pip, paho-mqtt daemon, SQLite & MariaDB, hourly SQL downsampling queries, Flask REST API, multi-device routing, and sub-second WebSockets.',
            ],
            'babak4' => [
                'title' => 'Full Stack Web Dashboard, Mobile PWA & Bot Alerts',
                'blurb' => 'Modern Tailwind CSS UI, live WebSocket client, dual-chart Chart.js, web relay toggle switches, stale data/offline UX, mobile PWA installation, and two-way Telegram bots.',
            ],
            'babak5' => [
                'title' => 'The Raspberry Pi Super-Upgrade — Edge Gateway 24/7',
                'blurb' => 'Headless Linux, SSH, UFW firewall, native Mosquitto on Pi, 24/7 systemd daemons, Nginx reverse proxy port 80, Node-RED visual automation, Docker Compose, and InfluxDB & Grafana.',
            ],
            'babak6' => [
                'title' => 'Industrial Security, Battery, OTA, Remote Access & Capstone',
                'blurb' => 'Broker authentication, MQTTS TLS 8883 encryption, Hardware Watchdog (WDT), ESP32 Deep Sleep battery operation, Arduino OTA Wi-Fi, Cloudflare Tunnel, and 3-part Capstone Portfolio.',
            ],
        ],
    ],
