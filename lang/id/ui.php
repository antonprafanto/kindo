...
return [
    ...
    'home' => [
        ...
        'fsiot_body' => 'Kurikulum terpadu 73 modul dari nol sedang disiapkan: dari elektronika DC, C++ ESP32, MQTT, backend Python, dashboard PWA, hingga Raspberry Pi Linux. Gratis dibaca saat rilis.',
        'fsiot_cta' => 'Lihat status jalur →',
        'fsiot_support' => 'Dukung di Trakteer',
        'beasiswa_badge_free' => 'Gratis',
        'beasiswa_badge_open' => 'Pendaftaran dibuka',
        'beasiswa_title' => 'Beasiswa AWS AI Academy 2026',
        'beasiswa_body' => 'Peluang pelatihan AI Development gratis dari AWS × Dicoding — tanpa batas usia. Mulai dari Python & cloud sampai machine learning. Daftar di situs resmi.',
        'beasiswa_cta' => 'Lihat peluang beasiswa →',
        'beasiswa_secondary' => 'Daftar sekarang ↗',
        'promo_carousel_label' => 'Sorotan program',
        'promo_carousel_prev' => 'Sebelumnya',
        'promo_carousel_next' => 'Berikutnya',
        'promo_carousel_goto' => 'Ke slide :num',
    ...
    'about' => [
        ...
        'fsiot_body' => 'Kami sedang menyiapkan kurikulum Full Stack IoT Developer — Dari Nol: 73 modul terpadu dari elektronika dasar sampai server edge 24/7. Halaman jalur sekarang menampilkan status segera hadir; materi dibuka bertahap.',
        'fsiot_cta' => 'Lihat status jalur →',
    ...
    'beasiswa' => [
        'meta_title' => 'Beasiswa IT & AI — Koding Indonesia',
        'meta_description' => 'Info beasiswa pelatihan IT & AI gratis untuk pelajar dan developer Indonesia. Termasuk AWS AI Academy bersama Dicoding — daftar langsung di situs resmi.',
        'meta_og_title' => 'Beasiswa IT & AI Gratis — Koding Indonesia',
        'meta_og_description' => 'Temukan peluang beasiswa pelatihan coding & AI gratis. AWS AI Academy terbuka untuk semua usia — mulai daftar sekarang.',
        'breadcrumb' => 'Beasiswa',
        'badge_free' => 'Gratis',
        'badge_open' => 'Pendaftaran dibuka',
        'heading' => 'Beasiswa belajar IT & AI',
        'intro' => 'Kurasi peluang beasiswa pelatihan dari penyelenggara terpercaya. Cocok buat pelajar, mahasiswa, dan siapa pun yang ingin naik level skill coding & AI — tanpa biaya.',
        'hero_cta' => 'Lihat peluang',
        'hero_secondary' => 'Belajar di sini dulu',
        'fact_cost_label' => 'Biaya',
        'fact_cost_value' => 'Gratis',
        'fact_age_label' => 'Usia',
        'fact_age_value' => 'Tanpa batas',
        'fact_mode_label' => 'Mode',
        'fact_mode_value' => 'Online mandiri',
        'aws_provider' => 'AWS × Dicoding',
        'aws_title' => 'AWS AI Academy 2026',
        'aws_tag' => 'AI Development',
        'aws_body' => 'Program beasiswa pelatihan AI Development dari Amazon Web Services bersama Dicoding. Mulai dari dasar Python & cloud sampai sistem machine learning — materi berjenjang, sertifikat industri, dan kuota besar untuk talenta Indonesia.',
        'aws_req_1' => 'Warga Negara Indonesia',
        'aws_req_2' => 'Punya laptop atau komputer',
        'aws_req_3' => 'Minat belajar Artificial Intelligence',
        'aws_req_4' => 'Tidak wajib punya latar belakang IT',
        'aws_stages_title' => 'Tahapan belajar',
        'aws_stage_status_closed' => 'Seleksi ditutup',
        'aws_stage_status_active' => 'Sedang berjalan',
        'aws_stage_status_open' => 'Berikutnya',
        'aws_stage1_title' => 'Level Dasar & Pemula',
        'aws_stage1_body' => 'Spec-driven Development with Kiro, dasar Cloud & Gen AI di AWS, Python, dan Machine Learning untuk pemula.',
        'aws_stage1_deadline' => 'Seleksi ke tahap 2 ditutup 19 Juni 2026 — materi dasar tetap bisa dipelajari setelah daftar',
        'aws_stage2_title' => 'Level Menengah',
        'aws_stage2_body' => 'Fundamental Deep Learning dan membangun arsitektur cloud di AWS.',
        'aws_stage2_deadline' => 'Deadline seleksi ke tahap 3: 28 Agustus 2026 — masih dibuka',
        'aws_stage3_title' => 'Level Mahir',
        'aws_stage3_body' => 'Membangun sistem Machine Learning end-to-end.',
        'aws_stage3_deadline' => 'Target selesai: 3 November 2026',
        'aws_cta_label' => 'Siap daftar?',
        'aws_cta_note' => 'Pendaftaran di situs resmi AWS AI Academy (dibuka sampai 25 Desember 2026). Butuh akun Dicoding.',
        'aws_cta' => 'Daftar sekarang',
        'aws_disclaimer' => 'Program diselenggarakan oleh AWS dan Dicoding. Koding Indonesia hanya menginformasikan peluang ini.',
        'aws_updated' => 'Info diperbarui Agustus 2026',
        'bridge_title' => 'Persiapan sebelum daftar',
        'bridge_body' => 'Belum familiar dengan coding? Mulai dari tutorial Koding Indonesia — Python, web, dan IoT — supaya langkah pertama di program AI lebih ringan.',
        'bridge_articles' => 'Jelajahi artikel →',
        'bridge_fsiot' => 'Jalur Full Stack IoT',
        'more_title' => 'Peluang berikutnya',
        'more_body' => 'Kami akan menambahkan beasiswa pelatihan IT relevan lainnya di halaman ini. Langganan newsletter agar tidak ketinggalan.',
        'more_cta' => 'Langganan newsletter →',
    ],

    'fsiot' => [
        'meta_title' => 'Full Stack IoT Developer — Dari Nol | Koding Indonesia',
        'meta_description' => 'Jalur unggulan Koding Indonesia: belajar Full Stack IoT dari awam hingga hero — gratis, berbahasa Indonesia, 73 modul terperinci dari nol. Dukung kami lewat Trakteer.',
        'meta_og_title' => 'Full Stack IoT Developer — Dari Nol',
        'meta_og_description' => 'Kurikulum komprehensif 73 modul (akses gratis) dari sensor sampai dashboard & Raspberry Pi. From zero to hero, berbahasa Indonesia.',
        'breadcrumb_learn' => 'Belajar',
        'badge' => 'Jalur unggulan · akses gratis',
        'title' => 'Full Stack IoT Developer',
        'intro' => 'Kurikulum dari nol sekali sampai mampu membangun sistem IoT utuh berstandar industri: dari listrik DC dasar, C++ hemat RAM, sensor BME280/LDR di ESP32-DevKitC-1, protokol MQTT, database SQLite/MariaDB, REST API Python & WebSockets, Web Dashboard PWA, hingga Edge Gateway 24/7 di Raspberry Pi dan Docker.',
        'soon_meta_title' => 'Full Stack IoT Developer — Segera Hadir | Koding Indonesia',
        'soon_meta_description' => 'Jalur Full Stack IoT Koding Indonesia sedang disiapkan dari nol: 73 modul terperinci, hardware hybrid ESP32 & Raspberry Pi. Langganan newsletter agar tahu saat dibuka.',
        'soon_meta_og_title' => 'Full Stack IoT — Segera Hadir',
        'soon_meta_og_description' => 'Kurikulum 73 modul dari nol sedang kami siapkan. Segera hadir — gratis dibaca saat rilis.',
        'soon_badge' => 'Segera hadir',
        'soon_headline' => 'Jalur belajar Full Stack IoT sedang kami siapkan dari nol dengan teliti.',
        'soon_body' => 'Kurikulum master 73 modul terpadu dalam 6 babak pembelajaran: dari fondasi elektronika & C++ ESP32, konektivitas MQTT, backend Python & database, Web Dashboard PWA di smartphone, hingga server mini Linux 24/7 di Raspberry Pi. Simpan halaman ini atau langganan newsletter agar tahu saat modul resmi dibuka.',
        'soon_board_title' => 'Hardware & Pendekatan Belajar',
        'soon_board_body' => 'Sistem Hybrid yang inklusif: Cukup bermodalkan ESP32-DevKitC-1 (~Rp 50rb) dan laptop sehari-hari untuk menyelesaikan 100% materi. Tersedia babak khusus Super-Upgrade bagi pemilik Raspberry Pi (atau alternatif hemat STB Linux bekas).',
        ...
        'soon_roadmap_title' => 'Ikhtisar 6 Babak Kurikulum (73 Modul)',
        ...
        'stat_modules' => 'Modul terperinci',
        'stat_modules_hint' => '6 babak pembelajaran',
        'stat_lang' => 'Bahasa & Standar',
        'stat_lang_value' => 'ID + EN',
        'stat_lang_hint' => 'ramah awam & industri',
        'stat_cost' => 'Biaya akses',
        'stat_cost_value' => 'Gratis',
        'stat_cost_hint' => 'starter kit ~Rp 180rb',
        'thread_title' => 'Proyek Benang Merah: Stasiun Ruang Belajar',
        'thread_body' => 'Seluruh jalur mengitari satu proyek nyata yang terus berkembang: membangun Stasiun Ruang Belajar Pintar — memantau suhu presisi (BME280), intensitas cahaya (LDR), sakelar relay beban aman dengan histeresis, buffer offline MicroSD, backend Python SQLite/MariaDB, live WebSockets, PWA mobile, alert Telegram dua arah, hingga server Linux 24/7 di Raspberry Pi.',
        'thread_status' => 'Materi terbit bertahap dan harus diikuti berurutan, dimulai dari Modul M-01 (#71: Pintu Masuk IoT). Simpan halaman ini sebagai gerbang masuk resmi jalur.',
        'phases_title' => 'Enam Babak Pembelajaran (73 Modul)',
        'support_title' => 'Dukung Koding Indonesia',
        'support_body' => 'Jalur ini gratis dibaca saat rilis. Kalau kurikulum kami membantu, kamu bisa mendukung lewat tip di Trakteer — untuk operasional server, perlengkapan hardware, dan penulisan konten.',
        ...
        'phases' => [
            'babak1' => [
                'title' => 'Fondasi Kelistrikan, Hardware, Pinout & Pemrograman C++',
                'blurb' => 'Listrik DC aman, multimeter, breadboard, hukum Ohm, proteksi brownout & ground, strapping pins, C++ hemat RAM, PWM, sensor BME280/LDR, relay histeresis, OLED, dan memori NVS Preferences.',
            ],
            'babak2' => [
                'title' => 'Jaringan, Konektivitas, Multitasking & Protokol MQTT',
                'blurb' => 'Wi-Fi STA auto-reconnect, captive portal WiFiManager, NTP time sync, FreeRTOS dual-core multitasking, arsitektur MQTT Mosquitto, JSON telemetry, MQTT LWT & Retain, dan buffer MicroSD.',
            ],
            'babak3' => [
                'title' => 'Data Engine, SQL Agregasi & Backend Server di Laptop',
                'blurb' => 'Python venv/pip, daemon paho-mqtt, database SQLite & MariaDB, query downsampling SQL agregasi per jam, Flask REST API, multi-device filter, dan WebSockets sub-detik.',
            ],
            'babak4' => [
                'title' => 'Full Stack Web Dashboard, Mobile PWA & Bot Alert',
                'blurb' => 'Desain web modern Tailwind CSS, client WebSocket live, dual-chart Chart.js, sakelar kontrol relay web, UX data basi/offline, instalasi PWA di smartphone, dan Bot Telegram dua arah.',
            ],
            'babak5' => [
                'title' => 'The Raspberry Pi Super-Upgrade — Edge Gateway 24/7',
                'blurb' => 'Linux headless, SSH, firewall UFW, Mosquitto di Pi, auto-start systemd 24/7, Nginx reverse proxy port 80, otomasi visual Node-RED, Docker Compose, serta InfluxDB & Grafana.',
            ],
            'babak6' => [
                'title' => 'Keamanan Industri, Baterai, OTA, Remote Access & Capstone',
                'blurb' => 'Auth broker Mosquitto, enkripsi MQTTS TLS 8883, Hardware Watchdog (WDT), ESP32 Deep Sleep baterai, Arduino OTA Wi-Fi, Cloudflare Tunnel, dan 3 bagian Capstone Portofolio.',
            ],
        ],
    ],
    ...
    'articles' => [
        ...
        'fsiot_quiz_hint' => 'Pilih arti untuk tiap istilah di browser. Target ≥ 12/15. Batas waktu mulai saat kamu menjawab soal pertama.',
        ...
        'fsiot_quiz_pass' => 'Skor :score/:total — lulus! Lanjut ke langkah berikutnya di artikel ini (checklist / modul berikutnya saat terbit).',
        ...
        'fsiot_quiz_timer' => 'Sisa waktu :time',
        'fsiot_quiz_timer_idle' => 'Batas :minutes menit — mulai saat soal pertama dijawab',
        'fsiot_quiz_timer_up' => 'Waktu habis. Skor :score/:total dari jawaban yang sempat diisi. Tekan Coba lagi untuk mengulang.',
        'fsiot_quiz_timer_up_pass' => 'Waktu habis — skor :score/:total. Lulus! Tekan Coba lagi jika ingin mengulang untuk latihan.',
