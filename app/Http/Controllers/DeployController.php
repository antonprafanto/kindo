...
class DeployController extends Controller
{
    ...
    public function publishArticle53(): Response
    {
        ...
        $body = (string) $article->body;
        if (! str_contains($body, 'oop53phpArrow') || ! str_contains($body, 'color:#1a1a1a') || ! str_contains($body, 'oop_php_dasar.php') || ! str_contains($body, 'class Buku') || ! str_contains($body, 'demo(') || ! str_contains($body, 'Seri 4') || ! str_contains($body, '#53 (ini)') || ! str_contains($body, '7/8 menuju Capstone Laravel') || ! str_contains($body, 'type hint') || ! str_contains($body, 'oop-php-property-method-constructor')) {
    ...
    public function publishArticle54(): Response
    {
        ...
        $body = (string) $article->body;
        if (! str_contains($body, 'oop54phpArrow') || ! str_contains($body, 'color:#1a1a1a') || ! str_contains($body, 'oop_php_property.php') || ! str_contains($body, 'class Buku') || ! str_contains($body, '__construct') || ! str_contains($body, 'demo(') || ! str_contains($body, 'Seri 4') || ! str_contains($body, '#54 (ini)') || ! str_contains($body, '7/8 menuju Capstone Laravel') || ! str_contains($body, $prevSlug) || ! str_contains($body, 'oop-php-visibility-composition')) {
    ...
    public function publishArticle55(): Response
    {
        ...
        $body = (string) $article->body;
        if (! str_contains($body, 'oop55phpArrow') || ! str_contains($body, 'color:#1a1a1a') || ! str_contains($body, 'oop_php_visibility.php') || ! str_contains($body, 'class Buku') || ! str_contains($body, 'class Katalog') || ! str_contains($body, 'private') || ! str_contains($body, 'demo(') || ! str_contains($body, 'Seri 4') || ! str_contains($body, '#55 (ini)') || ! str_contains($body, '7/8 menuju Capstone Laravel') || ! str_contains($body, $prevSlug) || ! str_contains($body, 'laravel-routing-json-perpustakaan-api')) {
    ...
    public function publishArticle58(): Response
    {
        ...
        $body = (string) $article->body;
        if (! str_contains($body, 'laravel58ctrlArrow') || ! str_contains($body, 'color:#1a1a1a') || ! str_contains($body, 'laravel_controller_service_demo.php') || ! str_contains($body, 'BukuService') || ! str_contains($body, 'BukuController') || ! str_contains($body, 'Eloquent') || ! str_contains($body, 'demo(') || ! str_contains($body, 'Seri 4') || ! str_contains($body, '#58 (ini)') || ! str_contains($body, '7/8 menuju Capstone Laravel') || ! str_contains($body, $prevSlug) || ! str_contains($body, 'pengatur kode') || ! str_contains($body, 'otentikasi') || ! str_contains($body, 'langkah kerja') || ! str_contains($body, 'validated()') || ! str_contains($body, 'JsonResponse') || ! str_contains($body, 'callable') || ! str_contains($body, 'Perintah database tersebar') || ! str_contains($body, 'laravel-auth-api-dasar')) {
    ...
    public function publishArticle59(): Response
    {
        ...
        $body = (string) $article->body;
        if (! str_contains($body, 'laravel59authArrow') || ! str_contains($body, 'color:#1a1a1a') || ! str_contains($body, 'laravel_auth_api_demo.php') || ! str_contains($body, 'bukti_masuk') || ! str_contains($body, '401') || ! str_contains($body, 'demo(') || ! str_contains($body, 'Seri 4') || ! str_contains($body, '#59 (ini)') || ! str_contains($body, '7/8 menuju Capstone Laravel') || ! str_contains($body, $prevSlug) || ! str_contains($body, 'otentikasi') || ! str_contains($body, 'Belum diizinkan') || ! str_contains($body, 'Capstone') || ! str_contains($body, 'LoginRequest') || ! str_contains($body, 'Authorization') || ! str_contains($body, 'Cek login')) {
