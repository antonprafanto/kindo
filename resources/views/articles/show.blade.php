...
const initFsiotInteractiveWidgets = () => {
    ...
    initFsiotPinChecklist();
    initFsiotBlinkChecklist();
    initFsiotBtnChecklist();
...
function initFsiotPinChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-pin-checklist',
        listId: 'fsiot-pin-checklist-items',
        storagePrefix: 'fsiot-cl-87',
        idPrefix: 'fsiot-pin',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_pin_badge')),
            hint: @js(__('ui.articles.fsiot_pin_hint')),
            check: @js(__('ui.articles.fsiot_pin_check')),
            retry: @js(__('ui.articles.fsiot_pin_retry')),
            paper: @js(__('ui.articles.fsiot_pin_paper')),
            progress: @js(__('ui.articles.fsiot_pin_progress')),
            pass: @js(__('ui.articles.fsiot_pin_pass')),
            incomplete: @js(__('ui.articles.fsiot_pin_incomplete')),
            done: @js(__('ui.articles.fsiot_pin_done')),
            todo: @js(__('ui.articles.fsiot_pin_todo')),
        },
    });
}

function initFsiotBlinkChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-blink-checklist',
        listId: 'fsiot-blink-checklist-items',
        storagePrefix: 'fsiot-cl-88',
        idPrefix: 'fsiot-blink',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_blink_badge')),
            hint: @js(__('ui.articles.fsiot_blink_hint')),
            check: @js(__('ui.articles.fsiot_blink_check')),
            retry: @js(__('ui.articles.fsiot_blink_retry')),
            paper: @js(__('ui.articles.fsiot_blink_paper')),
            progress: @js(__('ui.articles.fsiot_blink_progress')),
            pass: @js(__('ui.articles.fsiot_blink_pass')),
            incomplete: @js(__('ui.articles.fsiot_blink_incomplete')),
            done: @js(__('ui.articles.fsiot_blink_done')),
            todo: @js(__('ui.articles.fsiot_blink_todo')),
        },
    });
}

function initFsiotBtnChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-btn-checklist',
        listId: 'fsiot-btn-checklist-items',
        storagePrefix: 'fsiot-cl-89',
        idPrefix: 'fsiot-btn',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_btn_badge')),
            hint: @js(__('ui.articles.fsiot_btn_hint')),
            check: @js(__('ui.articles.fsiot_btn_check')),
            retry: @js(__('ui.articles.fsiot_btn_retry')),
            paper: @js(__('ui.articles.fsiot_btn_paper')),
            progress: @js(__('ui.articles.fsiot_btn_progress')),
            pass: @js(__('ui.articles.fsiot_btn_pass')),
            incomplete: @js(__('ui.articles.fsiot_btn_incomplete')),
            done: @js(__('ui.articles.fsiot_btn_done')),
            todo: @js(__('ui.articles.fsiot_btn_todo')),
        },
    });
}

function initFsiotPwmChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-pwm-checklist',
        listId: 'fsiot-pwm-checklist-items',
        storagePrefix: 'fsiot-cl-90',
        idPrefix: 'fsiot-pwm',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_pwm_badge')),
            hint: @js(__('ui.articles.fsiot_pwm_hint')),
            check: @js(__('ui.articles.fsiot_pwm_check')),
            retry: @js(__('ui.articles.fsiot_pwm_retry')),
            paper: @js(__('ui.articles.fsiot_pwm_paper')),
            progress: @js(__('ui.articles.fsiot_pwm_progress')),
            pass: @js(__('ui.articles.fsiot_pwm_pass')),
            incomplete: @js(__('ui.articles.fsiot_pwm_incomplete')),
            done: @js(__('ui.articles.fsiot_pwm_done')),
            todo: @js(__('ui.articles.fsiot_pwm_todo')),
        },
    });
}

function initFsiotDhtChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-dht-checklist',
        listId: 'fsiot-dht-checklist-items',
        storagePrefix: 'fsiot-cl-91',
        idPrefix: 'fsiot-dht',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_dht_badge')),
            hint: @js(__('ui.articles.fsiot_dht_hint')),
            check: @js(__('ui.articles.fsiot_dht_check')),
            retry: @js(__('ui.articles.fsiot_dht_retry')),
            paper: @js(__('ui.articles.fsiot_dht_paper')),
            progress: @js(__('ui.articles.fsiot_dht_progress')),
            pass: @js(__('ui.articles.fsiot_dht_pass')),
            incomplete: @js(__('ui.articles.fsiot_dht_incomplete')),
            done: @js(__('ui.articles.fsiot_dht_done')),
            todo: @js(__('ui.articles.fsiot_dht_todo')),
        },
    });
}

function initFsiotLdrChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-ldr-checklist',
        listId: 'fsiot-ldr-checklist-items',
        storagePrefix: 'fsiot-cl-92',
        idPrefix: 'fsiot-ldr',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_ldr_badge')),
            hint: @js(__('ui.articles.fsiot_ldr_hint')),
            check: @js(__('ui.articles.fsiot_ldr_check')),
            retry: @js(__('ui.articles.fsiot_ldr_retry')),
            paper: @js(__('ui.articles.fsiot_ldr_paper')),
            progress: @js(__('ui.articles.fsiot_ldr_progress')),
            pass: @js(__('ui.articles.fsiot_ldr_pass')),
...
function initFsiotMosquittoChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-mosquitto-checklist',
        listId: 'fsiot-mosquitto-checklist-items',
        storagePrefix: 'fsiot-cl-103',
        idPrefix: 'fsiot-mosquitto',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_mosquitto_badge')),
            hint: @js(__('ui.articles.fsiot_mosquitto_hint')),
            check: @js(__('ui.articles.fsiot_mosquitto_check')),
            retry: @js(__('ui.articles.fsiot_mosquitto_retry')),
            paper: @js(__('ui.articles.fsiot_mosquitto_paper')),
            progress: @js(__('ui.articles.fsiot_mosquitto_progress')),
            pass: @js(__('ui.articles.fsiot_mosquitto_pass')),
            incomplete: @js(__('ui.articles.fsiot_mosquitto_incomplete')),
            done: @js(__('ui.articles.fsiot_mosquitto_done')),
            todo: @js(__('ui.articles.fsiot_mosquitto_todo')),
        },
    });
}

function initFsiotTelemetryChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-telemetry-checklist',
        listId: 'fsiot-telemetry-checklist-items',
        storagePrefix: 'fsiot-cl-104',
        idPrefix: 'fsiot-telemetry',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_telemetry_badge')),
            hint: @js(__('ui.articles.fsiot_telemetry_hint')),
            check: @js(__('ui.articles.fsiot_telemetry_check')),
            retry: @js(__('ui.articles.fsiot_telemetry_retry')),
            paper: @js(__('ui.articles.fsiot_telemetry_paper')),
            progress: @js(__('ui.articles.fsiot_telemetry_progress')),
            pass: @js(__('ui.articles.fsiot_telemetry_pass')),
...
function initFsiotSdChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-sd-checklist',
        listId: 'fsiot-sd-checklist-items',
        storagePrefix: 'fsiot-cl-106',
        idPrefix: 'fsiot-sd',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_sd_badge')),
            hint: @js(__('ui.articles.fsiot_sd_hint')),
            check: @js(__('ui.articles.fsiot_sd_check')),
            retry: @js(__('ui.articles.fsiot_sd_retry')),
            paper: @js(__('ui.articles.fsiot_sd_paper')),
            progress: @js(__('ui.articles.fsiot_sd_progress')),
            pass: @js(__('ui.articles.fsiot_sd_pass')),
            incomplete: @js(__('ui.articles.fsiot_sd_incomplete')),
            done: @js(__('ui.articles.fsiot_sd_done')),
            todo: @js(__('ui.articles.fsiot_sd_todo')),
        },
    });
}

function initFsiotForwardChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-forward-checklist',
        listId: 'fsiot-forward-checklist-items',
        storagePrefix: 'fsiot-cl-107',
        idPrefix: 'fsiot-forward',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_forward_badge')),
            hint: @js(__('ui.articles.fsiot_forward_hint')),
            check: @js(__('ui.articles.fsiot_forward_check')),
            retry: @js(__('ui.articles.fsiot_forward_retry')),
            paper: @js(__('ui.articles.fsiot_forward_paper')),
            progress: @js(__('ui.articles.fsiot_forward_progress')),
            pass: @js(__('ui.articles.fsiot_forward_pass')),
            incomplete: @js(__('ui.articles.fsiot_forward_incomplete')),
            done: @js(__('ui.articles.fsiot_forward_done')),
            todo: @js(__('ui.articles.fsiot_forward_todo')),
        },
    });
}

function initFsiotPythonChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-python-checklist',
        listId: 'fsiot-python-checklist-items',
        storagePrefix: 'fsiot-cl-109',
        idPrefix: 'fsiot-python',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_python_badge')),
            hint: @js(__('ui.articles.fsiot_python_hint')),
            check: @js(__('ui.articles.fsiot_python_check')),
            retry: @js(__('ui.articles.fsiot_python_retry')),
            paper: @js(__('ui.articles.fsiot_python_paper')),
            progress: @js(__('ui.articles.fsiot_python_progress')),
            pass: @js(__('ui.articles.fsiot_python_pass')),
...
function initFsiotFlaskChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-flask-checklist',
        listId: 'fsiot-flask-checklist-items',
        storagePrefix: 'fsiot-cl-112',
        idPrefix: 'fsiot-flask',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_flask_badge')),
            hint: @js(__('ui.articles.fsiot_flask_hint')),
            check: @js(__('ui.articles.fsiot_flask_check')),
            retry: @js(__('ui.articles.fsiot_flask_retry')),
            paper: @js(__('ui.articles.fsiot_flask_paper')),
            progress: @js(__('ui.articles.fsiot_flask_progress')),
            pass: @js(__('ui.articles.fsiot_flask_pass')),
            incomplete: @js(__('ui.articles.fsiot_flask_incomplete')),
            done: @js(__('ui.articles.fsiot_flask_done')),
            todo: @js(__('ui.articles.fsiot_flask_todo')),
        },
    });
}

function initFsiotDeviceChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-device-checklist',
        listId: 'fsiot-device-checklist-items',
        storagePrefix: 'fsiot-cl-113',
        idPrefix: 'fsiot-device',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_device_badge')),
            hint: @js(__('ui.articles.fsiot_device_hint')),
            check: @js(__('ui.articles.fsiot_device_check')),
            retry: @js(__('ui.articles.fsiot_device_retry')),
            paper: @js(__('ui.articles.fsiot_device_paper')),
            progress: @js(__('ui.articles.fsiot_device_progress')),
            pass: @js(__('ui.articles.fsiot_device_pass')),
            incomplete: @js(__('ui.articles.fsiot_device_incomplete')),
            done: @js(__('ui.articles.fsiot_device_done')),
            todo: @js(__('ui.articles.fsiot_device_todo')),
        },
    });
}

function initFsiotDashChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-dash-checklist',
        listId: 'fsiot-dash-checklist-items',
        storagePrefix: 'fsiot-cl-114',
        idPrefix: 'fsiot-dash',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_dash_badge')),
            hint: @js(__('ui.articles.fsiot_dash_hint')),
            check: @js(__('ui.articles.fsiot_dash_check')),
            retry: @js(__('ui.articles.fsiot_dash_retry')),
            paper: @js(__('ui.articles.fsiot_dash_paper')),
            progress: @js(__('ui.articles.fsiot_dash_progress')),
            pass: @js(__('ui.articles.fsiot_dash_pass')),
            incomplete: @js(__('ui.articles.fsiot_dash_incomplete')),
            done: @js(__('ui.articles.fsiot_dash_done')),
            todo: @js(__('ui.articles.fsiot_dash_todo')),
        },
    });
}

function initFsiotChartChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-chart-checklist',
        listId: 'fsiot-chart-checklist-items',
        storagePrefix: 'fsiot-cl-115',
        idPrefix: 'fsiot-chart',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_chart_badge')),
            hint: @js(__('ui.articles.fsiot_chart_hint')),
            check: @js(__('ui.articles.fsiot_chart_check')),
            retry: @js(__('ui.articles.fsiot_chart_retry')),
            paper: @js(__('ui.articles.fsiot_chart_paper')),
            progress: @js(__('ui.articles.fsiot_chart_progress')),
            pass: @js(__('ui.articles.fsiot_chart_pass')),
            incomplete: @js(__('ui.articles.fsiot_chart_incomplete')),
            done: @js(__('ui.articles.fsiot_chart_done')),
            todo: @js(__('ui.articles.fsiot_chart_todo')),
        },
    });
}

function initFsiotControlChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-control-checklist',
        listId: 'fsiot-control-checklist-items',
        storagePrefix: 'fsiot-cl-116',
        idPrefix: 'fsiot-control',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_control_badge')),
            hint: @js(__('ui.articles.fsiot_control_hint')),
            check: @js(__('ui.articles.fsiot_control_check')),
            retry: @js(__('ui.articles.fsiot_control_retry')),
            paper: @js(__('ui.articles.fsiot_control_paper')),
            progress: @js(__('ui.articles.fsiot_control_progress')),
            pass: @js(__('ui.articles.fsiot_control_pass')),
...
function initFsiotRulesChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-rules-checklist',
        listId: 'fsiot-rules-checklist-items',
        storagePrefix: 'fsiot-cl-108',
        idPrefix: 'fsiot-rules',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_rules_badge')),
            hint: @js(__('ui.articles.fsiot_rules_hint')),
            check: @js(__('ui.articles.fsiot_rules_check')),
            retry: @js(__('ui.articles.fsiot_rules_retry')),
            paper: @js(__('ui.articles.fsiot_rules_paper')),
            progress: @js(__('ui.articles.fsiot_rules_progress')),
            pass: @js(__('ui.articles.fsiot_rules_pass')),
            incomplete: @js(__('ui.articles.fsiot_rules_incomplete')),
            done: @js(__('ui.articles.fsiot_rules_done')),
            todo: @js(__('ui.articles.fsiot_rules_todo')),
        },
    });
}
...
function initFsiotAutoChecklist() {
    initFsiotChecklistWidget({
        h2Id: 'fsiot-auto-checklist',
        listId: 'fsiot-auto-checklist-items',
        storagePrefix: 'fsiot-cl-94',
        idPrefix: 'fsiot-auto',
        minItems: 10,
        labels: {
            badge: @js(__('ui.articles.fsiot_auto_badge')),
            hint: @js(__('ui.articles.fsiot_auto_hint')),
            check: @js(__('ui.articles.fsiot_auto_check')),
            retry: @js(__('ui.articles.fsiot_auto_retry')),
            paper: @js(__('ui.articles.fsiot_auto_paper')),
            progress: @js(__('ui.articles.fsiot_auto_progress')),
            pass: @js(__('ui.articles.fsiot_auto_pass')),
            incomplete: @js(__('ui.articles.fsiot_auto_incomplete')),
            done: @js(__('ui.articles.fsiot_auto_done')),
            todo: @js(__('ui.articles.fsiot_auto_todo')),
        },
    });
}
