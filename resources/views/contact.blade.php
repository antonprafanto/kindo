<x-layouts.app title="Kontak — Koding Indonesia">
    ...
    <div class="max-w-2xl mx-auto px-4 py-10 sm:py-16">
        ...
        <div class="mb-8 p-5 border-2 border-black text-sm theme-highlight" style="box-shadow: 4px 4px 0 #000;">
            <p class="font-bold mb-1 theme-heading">Ingin menjadi kontributor?</p>
