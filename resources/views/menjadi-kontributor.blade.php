<x-layouts.app title="Menjadi Kontributor — Koding Indonesia">
    ...
    <div class="max-w-4xl mx-auto px-4 py-10 sm:py-16">
        ...
        <div class="space-y-8 mb-14" style="font-family:'Inter',sans-serif; line-height:1.8;">
            ...
            <div class="p-6 sm:p-8 theme-paper border-2 border-black" style="box-shadow: 4px 4px 0 #000;">
                <h2 class="text-xl font-black mb-4 border-b-2 border-black pb-3">📝 Pedoman Penulisan</h2>
                <ul class="space-y-3 theme-body text-sm sm:text-base">
            ...
            <div class="p-6 sm:p-8 theme-paper border-2 border-black" style="box-shadow: 4px 4px 0 #000;">
                <h2 class="text-xl font-black mb-4 border-b-2 border-black pb-3">🏷️ Kategori & Tag</h2>
            ...
            <div class="p-6 sm:p-8 theme-paper border-2 border-black" style="box-shadow: 4px 4px 0 #000;">
                <h2 class="text-xl font-black mb-4 border-b-2 border-black pb-3">⚖️ Lisensi Konten</h2>
                <p class="theme-body text-sm sm:text-base">
                    Artikel yang diterbitkan dilisensikan di bawah
                    <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank" class="text-[#2979FF] font-semibold underline">CC BY-NC-SA 4.0</a>
