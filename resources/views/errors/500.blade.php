...
<head>
    ...
    <title>500 — Kesalahan Server · Koding Indonesia</title>
...
<body style="background: #F5F5F0; font-family: 'Space Grotesk', sans-serif; min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem;">
    ...
    <div class="text-center max-w-lg">
        ...
        <div class="inline-block text-white text-sm font-bold px-3 py-1.5 border-2 border-black mb-6" style="background: #000; box-shadow: 3px 3px 0 #FF7A2F; text-transform:uppercase; letter-spacing:.05em;">Kesalahan Server</div>
