...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 600" style="display:block;max-width:860px;width:100%;height:auto;font-family:Inter,system-ui,sans-serif">
  <defs>
  ...
  <rect x="0" y="0" width="860" height="600" fill="#F5F5F0" rx="6"/>
  ...
  <text x="430" y="62" text-anchor="middle" fill="#e3f2fd" font-size="12">192.168.1.50:1883 · auth kindo_esp32</text>
  <text x="430" y="78" text-anchor="middle" fill="#e3f2fd" font-size="11">Topic: kodingindonesia/esp32/...</text>
  <text x="430" y="94" text-anchor="middle" fill="#cfe4ff" font-size="10">Pusat MQTT — semua publish &amp; subscribe lewat sini</text>
  <rect x="48" y="192" width="264" height="72" rx="6" fill="#E8F4FF" stroke="#000" stroke-width="2.5"/>
  <text x="180" y="220" text-anchor="middle" fill="#1a1a1a" font-size="14" font-weight="700">Gateway utama</text>
  <text x="180" y="240" text-anchor="middle" fill="#4A5568" font-size="12">BME280 + soil moisture + LDR</text>
  <text x="180" y="256" text-anchor="middle" fill="#718096" font-size="11">GPIO 21/22 · 34 · 35</text>
  <rect x="548" y="192" width="264" height="72" rx="6" fill="#FFF3E8" stroke="#000" stroke-width="2.5"/>
  <text x="680" y="220" text-anchor="middle" fill="#1a1a1a" font-size="14" font-weight="700">Node aktuator</text>
  <text x="680" y="240" text-anchor="middle" fill="#4A5568" font-size="12">Relay pompa + lampu grow</text>
  <text x="680" y="256" text-anchor="middle" fill="#718096" font-size="11">GPIO 26 · 27 · topic pompa/kontrol</text>
  <rect x="48" y="312" width="264" height="56" rx="6" fill="#E8F4FF" stroke="#000" stroke-width="2" stroke-dasharray="6 4"/>
  <text x="180" y="336" text-anchor="middle" fill="#1a1a1a" font-size="13" font-weight="600">Node deep sleep</text>
  <text x="180" y="354" text-anchor="middle" fill="#718096" font-size="11">opsional · probe tanah jauh (#11)</text>
  <rect x="548" y="312" width="264" height="56" rx="6" fill="#FFF3E8" stroke="#000" stroke-width="2" stroke-dasharray="6 4"/>
  <text x="680" y="336" text-anchor="middle" fill="#1a1a1a" font-size="13" font-weight="600">Servo flap ventilasi</text>
  <text x="680" y="354" text-anchor="middle" fill="#718096" font-size="11">opsional · topic servo/sudut (#33)</text>
  <rect x="130" y="448" width="600" height="88" rx="6" fill="#F5F5F0" stroke="#000" stroke-width="2.5"/>
  <text x="430" y="476" text-anchor="middle" fill="#1a1a1a" font-size="14" font-weight="700">Dashboard &amp; Otomasi</text>
  <text x="430" y="498" text-anchor="middle" fill="#4A5568" font-size="12">InfluxDB + Grafana (#19) · Home Assistant (#21) · Node-RED (#23)</text>
  <text x="430" y="518" text-anchor="middle" fill="#718096" font-size="11">Subscriber Python (#18) · alert Telegram · threshold pompa</text>
  <rect x="48" y="384" width="72" height="64" rx="4" fill="#fff" stroke="#FF7A2F" stroke-width="2"/>
