...
<h2>Checklist sebelum FS-33</h2>
<ul id="fsiot-mqtt-intro-checklist-items"><li>Saya tahu broker adalah perantara pesan.</li><li>Saya tahu client dapat berupa ESP32 atau MQTTX.</li><li>Saya tahu topic adalah alamat pesan, bukan URL web.</li><li>Saya tahu publish berarti mengirim ke topic.</li><li>Saya tahu subscribe berarti menerima pesan dari topic.</li><li>Saya tidak memakai broker publik untuk lab ini.</li><li>MQTTX sudah terpasang atau saya tahu bagian yang perlu diselesaikan.</li><li>Saya belum perlu membuka Arduino IDE pada FS-32.</li></ul>
<p><strong>Cara menguji checklist:</strong> jelaskan alur ESP32 → broker → MQTTX dengan kata-katamu sendiri, lalu centang hanya yang sudah benar. Tidak perlu terminal atau perintah sintaks hari ini.</p>
...
<h2>Checklist before FS-33</h2><ul><li>I know that a broker is a message middleman.</li><li>I know that ESP32 and MQTTX can be clients.</li><li>I know that a topic is a message address, not a web URL.</li><li>I know that publish sends and subscribe receives.</li><li>I do not use a public broker for this lab.</li><li>MQTTX is installed, or I know what remains to install.</li></ul>
<p><strong>How to test this checklist:</strong> explain ESP32 → broker → MQTTX in your own words, then tick only the true items. No terminal command is needed today.</p>
