...
<li><strong>Rakit di meja</strong> ikuti foto rangkaian (ESP32 di breadboard).</li>
...
<li>Letakkan <strong>breadboard</strong> di meja datar. ESP32 boleh dipasang di breadboard seperti foto (atau di samping dulu, lalu sambungkan jumper).</li>
<li>Siapkan <strong>jumper</strong>: minimal merah (3V3), hitam (GND), plus jumper lain sesuai foto.</li>
...
<li><strong>Pasang ESP32</strong> di breadboard melintasi parit seperti foto (USB menghadap keluar/kanan).</li>
...
<li><strong>Kolom 2:</strong> jumper merah dari rail merah (+) ke lubang di <strong>kolom 2</strong> (misalnya baris J / sisi F–J). <em>Ini kabel yang nanti dicabut untuk mematikan LED.</em></li>
<li><strong>Resistor 220Ω:</strong> satu kaki di <strong>kolom 2</strong>, kaki lain di <strong>kolom 7</strong> (lihat foto). Cincin umum: merah–merah–cokelat–emas.</li>
<li><strong>LED:</strong> kaki <strong>panjang (+)</strong> di <strong>kolom 7</strong> (sisi resistor), kaki <strong>pendek (−)</strong> di <strong>kolom 8</strong> — LED melintasi parit. Polaritas harus benar.</li>
<li><strong>Ke GND:</strong> jumper hitam dari kolom kaki pendek LED ke rail biru (−).</li>
<li><strong>Cek visual:</strong> tidak ada short 3V3–GND di kolom yang sama · LED tidak terbalik · rail + hanya dari 3V3 · rail − hanya ke GND.</li>
...
<li>Resistor 220 ohm (atau 330 ohm) terpasang di jalur 3V3 → LED (lihat foto: kolom 2 → 7)</li>
...
<li><strong>Build on the desk</strong> following the circuit photo (ESP32 on the breadboard).</li>
...
<li>Place the <strong>breadboard</strong> on a flat desk. The ESP32 can sit on the breadboard like the photo (or beside it first, then connect jumpers).</li>
<li>Prepare <strong>jumpers</strong>: at least red (3V3), black (GND), plus others as in the photo.</li>
...
<li><strong>Mount the ESP32</strong> across the ditch as in the photo (USB facing out/right).</li>
...
<li><strong>Column 2:</strong> red jumper from the (+) rail to a hole in <strong>column 2</strong> (e.g. row J / F–J side). <em>This wire gets unplugged to turn the LED off.</em></li>
<li><strong>220Ω resistor:</strong> one leg in <strong>column 2</strong>, the other in <strong>column 7</strong> (see the photo). Common bands: red–red–brown–gold.</li>
<li><strong>LED:</strong> <strong>long (+)</strong> leg in <strong>column 7</strong> (resistor side), <strong>short (−)</strong> leg in <strong>column 8</strong> — LED across the ditch. Polarity must be correct.</li>
<li><strong>To GND:</strong> black jumper from the LED short-leg column to the blue (−) rail.</li>
<li><strong>Visual check:</strong> no 3V3–GND short in the same column · LED not reversed · + rail only from 3V3 · − rail only to GND.</li>
...
<li>220 ohm (or 330 ohm) resistor in the 3V3 → LED path (see photo: columns 2 → 7)</li>
