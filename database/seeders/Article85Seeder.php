...
<figure style="margin:1.5rem 0;max-width:100%">
  ...
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
    <strong>ESP32-DevKitC</strong> — colok <strong>kabel USB data</strong> di label <strong>(6)</strong>. Tombol <strong>EN (7)</strong> = reset board (berguna jika hitungan sudah lewat). Hari ini kita menghitung di kode, bukan menambah sensor.
...
<figure style="margin:1.5rem 0;max-width:100%">
  ...
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
    <strong>ESP32-DevKitC</strong> — plug a <strong>USB data cable</strong> at label <strong>(6)</strong>. The <strong>EN (7)</strong> button resets the board (useful if the count already scrolled by). Today we count in code; no new sensors.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 200" width="100%" height="auto" role="img" aria-label="for steps">
  <text x="430" y="24" text-anchor="middle" font-family="system-ui,sans-serif" font-size="15" font-weight="700" fill="#1a1a1a">for = hitung berulang dengan batas jelas</text>
  <rect x="20" y="44" width="170" height="110" rx="10" fill="#E3F2FD" stroke="#1565C0" stroke-width="2.5"/>
  <text x="105" y="78" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="#0D47A1">1. mulai</text>
  <text x="105" y="108" text-anchor="middle" font-family="Consolas,monospace" font-size="13" fill="#1565C0">i = 1</text>
  <text x="105" y="136" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#1565C0">nilai awal</text>
  <text x="205" y="105" text-anchor="middle" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="#1a1a1a">→</text>
  <rect x="225" y="44" width="170" height="110" rx="10" fill="#E8F5E9" stroke="#2E7D32" stroke-width="2.5"/>
  <text x="310" y="78" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="#1B5E20">2. cek</text>
  <text x="310" y="108" text-anchor="middle" font-family="Consolas,monospace" font-size="13" fill="#2E7D32">i &lt;= 10 ?</text>
  <text x="310" y="136" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#2E7D32">masih lanjut?</text>
  <text x="410" y="105" text-anchor="middle" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="#1a1a1a">→</text>
  <rect x="430" y="44" width="170" height="110" rx="10" fill="#FFF8E1" stroke="#F9A825" stroke-width="2.5"/>
  <text x="515" y="78" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="#F57F17">3. kerja</text>
  <text x="515" y="108" text-anchor="middle" font-family="Consolas,monospace" font-size="13" fill="#F9A825">println(i)</text>
  <text x="515" y="136" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#F9A825">cetak angka</text>
  <text x="615" y="105" text-anchor="middle" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="#1a1a1a">→</text>
  <rect x="635" y="44" width="200" height="110" rx="10" fill="#F3E5F5" stroke="#7B1FA2" stroke-width="2.5"/>
  <text x="735" y="78" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="#6A1B9A">4. naikkan</text>
  <text x="735" y="108" text-anchor="middle" font-family="Consolas,monospace" font-size="13" fill="#7B1FA2">i = i + 1</text>
  <text x="735" y="136" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#7B1FA2">lalu kembali ke cek</text>
  <text x="430" y="182" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#546E7A">Alur: mulai → cek → kerja → naikkan → (cek lagi) sampai berhenti</text>
</svg>
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 200" width="100%" height="auto" role="img" aria-label="for steps">
  <text x="430" y="24" text-anchor="middle" font-family="system-ui,sans-serif" font-size="15" font-weight="700" fill="#1a1a1a">for = repeat with a clear limit</text>
  <rect x="20" y="44" width="170" height="110" rx="10" fill="#E3F2FD" stroke="#1565C0" stroke-width="2.5"/>
  <text x="105" y="78" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="#0D47A1">1. start</text>
  <text x="105" y="108" text-anchor="middle" font-family="Consolas,monospace" font-size="13" fill="#1565C0">i = 1</text>
  <text x="105" y="136" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#1565C0">initial value</text>
  <text x="205" y="105" text-anchor="middle" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="#1a1a1a">→</text>
  <rect x="225" y="44" width="170" height="110" rx="10" fill="#E8F5E9" stroke="#2E7D32" stroke-width="2.5"/>
  <text x="310" y="78" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="#1B5E20">2. check</text>
  <text x="310" y="108" text-anchor="middle" font-family="Consolas,monospace" font-size="13" fill="#2E7D32">i &lt;= 10 ?</text>
  <text x="310" y="136" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#2E7D32">keep going?</text>
  <text x="410" y="105" text-anchor="middle" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="#1a1a1a">→</text>
  <rect x="430" y="44" width="170" height="110" rx="10" fill="#FFF8E1" stroke="#F9A825" stroke-width="2.5"/>
  <text x="515" y="78" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="#F57F17">3. work</text>
  <text x="515" y="108" text-anchor="middle" font-family="Consolas,monospace" font-size="13" fill="#F9A825">println(i)</text>
  <text x="515" y="136" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#F9A825">print the number</text>
  <text x="615" y="105" text-anchor="middle" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="#1a1a1a">→</text>
  <rect x="635" y="44" width="200" height="110" rx="10" fill="#F3E5F5" stroke="#7B1FA2" stroke-width="2.5"/>
  <text x="735" y="78" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="#6A1B9A">4. step</text>
  <text x="735" y="108" text-anchor="middle" font-family="Consolas,monospace" font-size="13" fill="#7B1FA2">i = i + 1</text>
  <text x="735" y="136" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#7B1FA2">then check again</text>
  <text x="430" y="182" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" fill="#546E7A">Flow: start → check → work → step → (check again) until it stops</text>
</svg>
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 320" width="100%" height="auto" role="img" aria-label="Serial count 1-10">
  ...
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
    <strong>Intinya:</strong> angka muncul berurutan sekali setelah Upload (karena <code>for</code> di <code>setup</code>). Jika sudah lewat, tekan tombol <strong>EN (7)</strong> di board.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 320" width="100%" height="auto" role="img" aria-label="Serial count 1-10">
  ...
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
    <strong>In short:</strong> numbers appear in order once after Upload (because <code>for</code> is in <code>setup</code>). If you missed them, press the <strong>EN (7)</strong> button on the board.
...
<ol>
<li>Arduino IDE → <strong>File → New Sketch</strong> → <strong>Simpan sebagai</strong> <code>FS15_hitung</code>.</li>
...
<li>Amati hitungan 1–10. Jika sudah lewat, tekan tombol <strong>EN (7)</strong> di board (reset), lalu buka Serial lagi.</li>
</ol>
...
<li><strong>Melewatkan Serial karena for di setup.</strong> Tekan tombol <strong>EN (7)</strong> / Upload ulang, lalu buka Serial cepat.</li>
...
<ol>
<li>Arduino IDE → <strong>File → New Sketch</strong> → <strong>Save as</strong> <code>FS15_hitung</code>.</li>
...
<li>Watch counts 1–10. If you missed them, press the <strong>EN (7)</strong> button on the board (reset), then open Serial again.</li>
</ol>
<pre><code class="language-cpp">// FS15_hitung — Full Stack IoT FS-15
...
<li><strong>Missing Serial because for is in setup.</strong> Press <strong>EN (7)</strong> / Upload again, then open Serial quickly.</li>
