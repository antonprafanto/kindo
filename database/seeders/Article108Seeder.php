...
class Article108Seeder extends Seeder
{
    ...
    private function body(): string
    {
        ...
        $deploy = $this->figure('fs38-threshold-deploy.png', 'Urutan ubah ambang: double-klik switch, ganti angka, klik Deploy, relay berubah tanpa Upload', '<strong>Ubah ambang di Node-RED, lalu Deploy.</strong> Jangan tekan Upload di Arduino IDE. USB ESP32 tetap colok. Diagram buatan Koding Indonesia (FS-38).');
...
<li><strong>Deploy</strong> — tombol di editor Node-RED. Artinya: pakai alur yang baru. Bukan Upload Arduino.</li>
...
<li>Klik tombol <strong>Deploy</strong>. Jangan tekan Upload di Arduino IDE.</li>
</ol>
...
HTML;
    ...
    private function bodyEn(): string
    {
        ...
        $deploy = $this->figure('fs38-threshold-deploy.png', 'Threshold change order: double-click switch, change the number, click Deploy, relay follows without Upload', '<strong>Change the threshold in Node-RED, then Deploy.</strong> Do not click Upload in Arduino IDE. Leave ESP32 USB plugged in. Diagram by Koding Indonesia (FS-38).');
...
<li><strong>Deploy</strong> — the button in the Node-RED editor. It means: use the new flow. It is not Arduino Upload.</li>
...
<li>Click <strong>Deploy</strong>. Do not click Upload in Arduino IDE.</li>
</ol>
