...
HTML;
    ...
    private function bodyEn(): string
    {
        ...
        $mqttx = $this->figure('fs35-mqttx-publish.png', 'Illustration of MQTTX ready to send a command: PC IPv4 Host, subscribe status, publish command', '<strong>MQTTX is ready to send a command to the ESP32.</strong> Host = the PC IPv4, Port = <code>1883</code>. Subscribe to <code>status</code>, then publish JSON to <code>command</code>. Do not copy a Host from an internet screenshot. Illustration by Koding Indonesia (FS-35), modelled on the official <a href="https://mqttx.app/" target="_blank" rel="noopener noreferrer">MQTTX by EMQ</a> layout (Apache License 2.0). The official window screenshot is not used as-is because it shows a public broker. The address <code>192.168.1.23</code> is only an example.');
