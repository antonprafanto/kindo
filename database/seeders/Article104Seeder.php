...
<h2>Persiapan — buka tool yang benar dulu</h2>{tools}<ol><li><strong>Buka browser.</strong> Siapkan untuk membaca panduan dan sumber resmi.</li><li><strong>Buka Arduino IDE.</strong> Kita memasang library sebelum menempel sketch.</li><li><strong>Siapkan ESP32, kabel data USB, modul DHT22, dan kabel jumper.</strong> Lepaskan USB sebelum mengubah wiring.</li><li><strong>Buka PowerShell di PC broker.</strong> Nanti kita mencari IPv4 PC lalu menjalankan Mosquitto.</li><li><strong>Buka MQTTX paling akhir.</strong> MQTTX dipakai untuk melihat pesan setelah broker dan ESP32 siap.</li></ol><p><strong>Tips membaca gambar:</strong> jika tulisan pada diagram terlalu kecil, gunakan fitur perbesar pada browser atau layar. Keterangan penting juga dijelaskan lagi dalam teks setelah gambar.</p><p><strong>Jangan dipakai hari ini:</strong> broker publik, port forwarding/router, relay, akun cloud, Laragon, <code>php artisan</code>, atau dashboard web.</p>
...
<h2>Preparation — open the right tools first</h2>{tools}<ol><li><strong>Open a browser.</strong> Keep this guide and official references available.</li><li><strong>Open Arduino IDE.</strong> Install libraries before pasting the sketch.</li><li><strong>Prepare ESP32, a data USB cable, DHT22 module, and jumpers.</strong> Unplug USB before changing wiring.</li><li><strong>Open PowerShell on the broker PC.</strong> We find the PC IPv4 address and run Mosquitto there.</li><li><strong>Open MQTTX last.</strong> It watches messages after broker and ESP32 are ready.</li></ol><p><strong>Diagram tip:</strong> if diagram text is too small, use your browser or device zoom. The important details are also explained in the text after each image.</p><p><strong>Not used today:</strong> a public broker, router port forwarding, relay, cloud account, Laragon, <code>php artisan</code>, or dashboard.</p>
