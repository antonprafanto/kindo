...
<h2>Pasang library di Arduino IDE</h2><p>Di Arduino IDE, buka <strong>Tools → Manage Libraries</strong>. Cari dan pasang satu per satu:</p><ol><li><strong>DHT sensor library</strong> oleh Adafruit. Jika diminta memasang <strong>Adafruit Unified Sensor</strong>, pilih <strong>Install All</strong>; dependensi itu memang dibutuhkan library DHT.</li><li><strong>ArduinoMqttClient</strong> oleh Arduino. Library ini mendukung pengiriman MQTT dan contoh resminya menyertakan ESP32.</li><li><strong>ArduinoJson</strong> oleh Benoit Blanchon. Lab ini memakai <code>JsonDocument</code> dan <code>serializeJson()</code>, jadi kamu tidak perlu merangkai JSON dengan tangan.</li></ol><p>Pilih board ESP32 dan port USB yang benar di menu <strong>Tools</strong> sebelum Verify.</p>
...
<h2>Install Arduino IDE libraries</h2><p>Open <strong>Tools → Manage Libraries</strong>. Install <strong>DHT sensor library</strong> by Adafruit and choose <strong>Install All</strong> if asked for Adafruit Unified Sensor. Then install <strong>ArduinoMqttClient</strong> by Arduino and <strong>ArduinoJson</strong> by Benoit Blanchon. Select the correct ESP32 board and USB port under <strong>Tools</strong> before Verify.</p>
