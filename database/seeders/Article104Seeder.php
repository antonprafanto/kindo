...
HTML;
    ...
    private function bodyEn(): string
    {
        ...
        $library = $this->figure('fs34-library-manager.png', 'Arduino IDE 2 Library Manager illustration: three-book icon, DHT sensor library search, INSTALL, ESP32 board', '<strong>Click the three-book icon in the left bar.</strong> Type <em>DHT sensor library</em>, then choose <strong>INSTALL</strong>. The board in the top-right is an <strong>ESP32</strong>, not an UNO. Illustration by Koding Indonesia (FS-34), modelled on Arduino IDE 2. The official window screenshot is not used as-is because it is dimmed and shows an UNO. Step reference: <a href="https://docs.arduino.cc/software/ide-v2/tutorials/ide-v2-installing-a-library/" target="_blank" rel="noopener noreferrer">Installing libraries — Arduino IDE 2</a>, Arduino S.r.l. Arduino documentation is licensed under Creative Commons Attribution-Share Alike 4.0.');
