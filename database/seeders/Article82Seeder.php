...
<figure style="margin:1.5rem 0;max-width:100%">
  <img src="/images/fsiot/fs11-ide-overview-cite.png" width="1280" height="720" alt="Arduino IDE 2 — cari ikon Open Serial Monitor di kanan atas toolbar" loading="eager" style="width:100%;height:auto;max-height:520px;object-fit:contain;border:2.5px solid #1a1a1a;border-radius:8px;background:#fff;padding:0.5rem">
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
    <strong>Arduino IDE 2</strong> — di toolbar kanan atas ada ikon <strong>Open Serial Monitor</strong> (kaca pembesar). Itu “layar” tempat teks dari <code>Serial.println</code> muncul. Board yang kita pilih tetap <strong>ESP32 Dev Module</strong> (abaikan contoh board lain di screenshot).
...
HTML;
    ...
    private function ideFigureEn(): string
    {
        return <<<'HTML'
<figure style="margin:1.5rem 0;max-width:100%">
  <img src="/images/fsiot/fs11-ide-overview-cite.png" width="1280" height="720" alt="Arduino IDE 2 — find the Open Serial Monitor icon on the top-right toolbar" loading="eager" style="width:100%;height:auto;max-height:520px;object-fit:contain;border:2.5px solid #1a1a1a;border-radius:8px;background:#fff;padding:0.5rem">
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
    <strong>Arduino IDE 2</strong> — on the top-right toolbar, open <strong>Open Serial Monitor</strong> (magnifying-glass icon). That panel is where <code>Serial.println</code> text appears. Keep board set to <strong>ESP32 Dev Module</strong> (ignore other boards in the screenshot).
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 240" width="100%" height="auto" role="img" aria-label="empat kotak variabel">
  ...
  <text x="730" y="175" text-anchor="middle" font-family="system-ui,sans-serif" font-size="11" fill="#8E24AA">teks (pelan-pelan)</text>
</svg>
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 240" width="100%" height="auto" role="img" aria-label="four variable boxes">
  ...
  <text x="730" y="150" text-anchor="middle" font-family="system-ui,sans-serif" font-size="16" font-weight="700">"Anton"</text>
  <text x="730" y="175" text-anchor="middle" font-family="system-ui,sans-serif" font-size="11" fill="#8E24AA">text (go slow)</text>
</svg>
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 280" width="100%" height="auto" role="img" aria-label="jendela Serial Monitor">
  <text x="430" y="26" text-anchor="middle" font-family="system-ui,sans-serif" font-size="15" font-weight="700">Serial Monitor (IDE 2) — “mata” kita hari ini</text>
  <rect x="40" y="45" width="780" height="200" rx="10" fill="#1E1E1E" stroke="#1a1a1a" stroke-width="2.5"/>
  <rect x="40" y="45" width="780" height="36" rx="10" fill="#2D2D2D"/>
  <text x="60" y="68" font-family="system-ui,sans-serif" font-size="12" fill="#B0BEC5">Serial Monitor · baud harus 115200</text>
  <text x="70" y="110" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">Halo dari ESP32 — FS12_hello</text>
  <text x="70" y="140" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">umur = 20</text>
  <text x="70" y="170" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">suhu = 28.50</text>
  <text x="70" y="200" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">siap = 1</text>
  <text x="70" y="225" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">nama = Anton</text>
  <rect x="560" y="210" width="230" height="28" rx="6" fill="#1565C0"/>
  <text x="675" y="229" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" font-weight="700" fill="#fff">115200 baud</text>
</svg>
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 280" width="100%" height="auto" role="img" aria-label="Serial Monitor window">
  <text x="430" y="26" text-anchor="middle" font-family="system-ui,sans-serif" font-size="15" font-weight="700">Serial Monitor (IDE 2) — our “eyes” today</text>
  <rect x="40" y="45" width="780" height="200" rx="10" fill="#1E1E1E" stroke="#1a1a1a" stroke-width="2.5"/>
  <rect x="40" y="45" width="780" height="36" rx="10" fill="#2D2D2D"/>
  <text x="60" y="68" font-family="system-ui,sans-serif" font-size="12" fill="#B0BEC5">Serial Monitor · baud must be 115200</text>
  <text x="70" y="110" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">Hello from ESP32 — FS12_hello</text>
  <text x="70" y="140" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">age = 20</text>
  <text x="70" y="170" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">tempC = 28.50</text>
  <text x="70" y="200" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">ready = 1</text>
  <text x="70" y="225" font-family="Consolas,monospace" font-size="14" fill="#A5D6A7">name = Anton</text>
  <rect x="560" y="210" width="230" height="28" rx="6" fill="#1565C0"/>
  <text x="675" y="229" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12" font-weight="700" fill="#fff">115200 baud</text>
</svg>
  <figcaption style="font-size:0.85rem;margin-top:0.5rem;color:#4A5568;">
...
<li>Baca bagian variabel + lihat gambar kotak.</li>
...
String nama = "Anton"; // teks — kenalan dulu, pelan-pelan
</code></pre>
...
<p><strong>Cara menguji di meja:</strong> setelah Upload, buka Serial Monitor di IDE → pastikan dropdown baud = <strong>115200</strong> → tekan tombol EN (reset) di board jika baris awal sudah lewat. Jangan uji dengan <code>php artisan</code>.</p>
...
<li>Tekan <strong>EN</strong> di board jika perlu → baca empat baris nilai.</li>
</ol>
...
<li>Read the variables section + look at the box figure.</li>
...
String name = "Anton"; // text — meet it gently today
</code></pre>
...
<p><strong>How to test at the desk:</strong> after Upload, open Serial Monitor in the IDE → set baud dropdown to <strong>115200</strong> → press the board EN (reset) button if early lines already passed. Do not test with <code>php artisan</code>.</p>
...
<li>Press <strong>EN</strong> on the board if needed → read the value lines.</li>
</ol>
<pre><code class="language-cpp">// FS12_hello — Full Stack IoT FS-12
