...
<ol style="list-style:none;padding:0;margin:0;color:#1a1a1a">
  ...
  <li style="display:flex;gap:1rem;padding:.9rem 0;color:#1a1a1a">
    ...
    <div style="color:#1a1a1a">
      ...
      <span style="display:block;color:#2D3748;margin-top:.25rem">Berikutnya: <a href="/artikel/laravel-instalasi-proyek-pertama">Instal PHP, Composer &amp; Proyek Laravel (#56)</a> — fondasi sebelum routing/API.</span>
    </div>
  </li>
</ol>
</figure>
...
<p><strong>Lanjut ke mana?</strong><br>Berikutnya: <a href="/artikel/laravel-instalasi-proyek-pertama">Instal PHP, Composer &amp; Proyek Laravel (#56)</a> — supaya lingkungan siap sebelum menulis route/API.</p>
...
<blockquote>
  <p><strong>Seri 4 progress:</strong> langkah <strong>#55 (ini)</strong> · jembatan OOP PHP <strong>3/3 selesai</strong> · prasyarat: <a href="/artikel/oop-php-property-method-constructor">Property, Method &amp; Constructor (#54)</a> LIVE. Berikutnya: <a href="/artikel/laravel-instalasi-proyek-pertama">Instal PHP, Composer &amp; Proyek Laravel (#56)</a>.</p>
</blockquote>
HTML;
    }
}
