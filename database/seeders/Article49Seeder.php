...
<p><strong>Ke mana setelah Seri 3?</strong><br>Lanjut Tier 2: <a href="/artikel/design-pattern-factory-strategy-python">Factory &amp; Strategy (#50)</a> — merapikan hutan <code>if</code> di Capstone · <a href="/artikel/oop-micropython-esp32-class-sensor">OOP MicroPython / ESP32 (#51)</a> — jembatan ke Seri IoT · <a href="/artikel/oop-flask-fastapi-class-api">Flask / FastAPI (#52)</a> — pintu Web Dev.</p>
