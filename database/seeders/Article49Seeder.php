...
<p><strong>Ke mana setelah Seri 3?</strong><br>Lihat kesimpulan di bawah — ide Tier 2 tanpa menunggu slug yang belum live.</p>
...
<p><strong>Seri 3 resmi selesai (10/10 artikel live).</strong> Ide lanjut (Tier 2, belum jadi artikel live): API Flask + model OOP, persistensi JSON untuk koleksi, atau pola OOP ringan di MicroPython untuk node IoT. Kalau kamu dari jalur perangkat, pola “service punya sensor/aktuator” sudah muncul di <a href="/artikel/smart-greenhouse-esp32-sensor-aktuator-dashboard-mqtt">capstone smart greenhouse (#39)</a> — OOP membantu merapikan firmware yang membesar.</p>
