...
<p><strong>Lanjut ke mana?</strong><br>Seri 4 Web Lanjut sedang disusun ulang ke jalur <strong>Laravel</strong> (plus jembatan OOP PHP). Pantau artikel berikutnya — belum hardlink sampai live.</p>
...
<p>Artikel ini adalah <strong>#52 (ini)</strong> — pintu web setelah <a href="/artikel/oop-micropython-esp32-class-sensor">MicroPython (#51)</a> dan <a href="/artikel/design-pattern-factory-strategy-python">Factory (#50)</a>. Seri 4 Web Lanjut (Laravel) menyusul.</p>

<blockquote>
  <p><strong>Tier 2 progress:</strong> langkah <strong>#52 (ini)</strong> · <a href="/artikel/oop-micropython-esp32-class-sensor">MicroPython (#51)</a> LIVE · <a href="/artikel/design-pattern-factory-strategy-python">Factory (#50)</a> LIVE · Seri 3 tetap 10/10 · Seri 4: Laravel (menyusul). Prasyarat: <a href="/artikel/oop-micropython-esp32-class-sensor">MicroPython (#51)</a> · <a href="/artikel/capstone-sistem-perpustakaan-mini-oop-python">Capstone (#49)</a> · <a href="/artikel/composition-vs-inheritance-python">Composition (#47)</a> · <a href="/artikel/design-pattern-factory-strategy-python">Factory (#50)</a> · <a href="/artikel/mengenal-oop-cara-berpikir-dengan-objek-python">OOP (#40)</a>.</p>
</blockquote>
HTML;
    }
}
