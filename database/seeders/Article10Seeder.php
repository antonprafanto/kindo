...
<p>Seri 10 artikel ini adalah fondasi capstone. <strong>Seri 2 ESP32/IoT Lanjutan</strong> sudah berjalan — lima belas artikel pertama (urutan publish):</p>
<ol>
...
<ul>
  <li>ESP-NOW antar ESP32 tanpa router WiFi (#25)</li>
</ul>
