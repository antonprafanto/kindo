...
<p>Seri 10 artikel ini adalah fondasi capstone. <strong>Seri 2 ESP32/IoT Lanjutan</strong> sudah berjalan — empat belas artikel pertama (urutan publish):</p>
<ol>
...
<ul>
  <li>REST API vs MQTT untuk proyek IoT (#20)</li>
</ul>
