...
check(str_contains($body, 'laragon.org'), 'Link unduh Laragon');
check(str_contains($body, 'apachefriends.org') || str_contains($body, 'XAMPP'), 'Mention/link XAMPP');
check(str_contains($body, 'windows.php.net') || str_contains($body, 'php.net'), 'Link unduh PHP alternatif');
check(str_contains($body, 'getcomposer.org'), 'Link unduh Composer');
...
check(str_contains($body, 'struktur folder') || str_contains($body, '.env') || str_contains($body, 'Artisan'), 'Jembatan #57');
