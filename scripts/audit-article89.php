...
check('no FS-10 GPIO0 reference photo', ! str_contains($id, 'fs10-button-pulldown-wiring') && ! str_contains($en, 'fs10-button-pulldown-wiring'));
check('FS-10 soft note only', str_contains($id, 'Catatan pola FS-10') && str_contains($en, 'FS-10 pattern note'));
