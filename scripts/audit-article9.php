...
check(str_contains($body, 'points="390,260 390,230 370,202"'), 'SVG topologi: SUB polyline kontinu');
check(str_contains($body, 'points="250,200 250,230 230,258"'), 'SVG topologi: PUB polyline kontinu');
