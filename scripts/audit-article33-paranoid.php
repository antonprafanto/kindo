...
check(str_contains($a10body, 'adc-esp32-sensor-analog-soil-moisture-ldr-mqtt'), '#10 link #35 ADC');
check(str_contains($a10body, 'esp8266-nodemcu-vs-esp32-kapan-pakai-upgrade'), '#10 link #36 ESP8266');
