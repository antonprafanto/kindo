...
check(str_contains($body53, '8/8 Capstone Laravel selesai'), '#53 Progress 5/8 setelah oke');
...
check(str_contains($deploy, 'oop54phpArrow') && str_contains($deploy, '8/8 Capstone Laravel selesai'), 'Hook body locks');
