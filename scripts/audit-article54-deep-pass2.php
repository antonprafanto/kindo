...
check(str_contains($body53, '4/8 menuju Capstone Laravel'), '#53 progress 4/8 setelah oke');
...
check(str_contains($deploy, 'oop54phpArrow') && str_contains($deploy, '4/8 menuju Capstone Laravel'), 'Hook body locks');
