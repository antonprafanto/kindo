...
check(str_contains($body53, '2/8 menuju Capstone Laravel'), '#53 progress 2/8 setelah oke');
...
check(str_contains($deploy, 'oop54phpArrow') && str_contains($deploy, '2/8 menuju Capstone Laravel'), 'Hook body locks');
