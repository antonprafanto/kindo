...
check(str_contains($body53, '3/8 menuju Capstone Laravel'), '#53 progress 3/8 setelah oke');
check(! str_contains($body53, '2/8 menuju Capstone Laravel'), '#53 tidak stale 2/8');
...
check(str_contains($deploy, 'oop54phpArrow') && str_contains($deploy, '3/8 menuju Capstone Laravel'), 'Hook body locks');
