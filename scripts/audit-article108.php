...
check108('wiring figure shows numbered jumpers not pin boxes only', str_contains($body, 'Enam kabel jumper') && str_contains($bodyEn, 'Each colored line is one jumper') && str_contains($assets, 'Satu garis = satu jumper'));
