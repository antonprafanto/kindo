...
check(! str_contains($body, '/artikel/special-methods-dataclass-python'), 'Tidak hardlink #48');
check(str_contains($body, 'dataclass') || str_contains($body, 'Special Methods'), 'Teaser #48 tanpa slug mati');
