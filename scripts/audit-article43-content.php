...
check(! str_contains($body, '/artikel/inheritance-pewarisan-class-python'), 'Tidak hardlink #44');
check(str_contains($body, 'Inheritance'), 'Teaser Inheritance tanpa slug mati');
check(substr_count($body, 'language-python') >= 4, 'Minimal 4 blok language-python');
