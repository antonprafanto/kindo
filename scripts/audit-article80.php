...
check('wiring matches photo columns ID', str_contains($id, 'kolom kaki atas tombol') && str_contains($id, 'Ke GND') && str_contains($id, 'kolom 2 dan 4'));
check('wiring matches photo columns EN', str_contains($en, 'top button-leg column') && str_contains($en, 'To GND') && str_contains($en, 'columns 2 and 4'));
