...
for x, label in [(890, 'MQTTX'), (1030, 'dashboard')]:
    box(draw, (x, 235, x + 115, 440), '#e8f5e9', '#2e7d32')
    text(draw, x + 57, 325, label, 18, '#287b35')
    text(draw, x + 57, 365, 'subscribe', 16)
draw.line((310, 338, 460, 338), fill='#f9a825', width=8)
draw.line((740, 338, 890, 338), fill='#2e7d32', width=8)
draw.line((740, 365, 1030, 365), fill='#2e7d32', width=8)
