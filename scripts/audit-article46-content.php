...
check(! preg_match('/(?<![\w\/"#>])#(?:4[7-9]|[5-9]\d)(?!\s*\(ini\))/', $plain), 'Tidak ada plain #47+ di luar link/pre');
...
check(! str_contains($body, '/artikel/composition-vs-inheritance-python'), 'Tidak hardlink #47');
