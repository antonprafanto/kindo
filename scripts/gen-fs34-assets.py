...
draw = ImageDraw.Draw(image)
header(draw, 1400, 'Klik ikon tiga buku di Arduino IDE 2', 'Cari DHT sensor library. Papan: ESP32 Dev Module.')
...
text(draw, 940, 490, 'Ketik DHT sensor library, lalu INSTALL.', 20, '#14532d')
text(draw, 940, 535, 'Papan di kanan: ESP32 Dev Module.', 18, '#166534')
...
# MQTTX JSON success — official MQTTX screenshots show a public broker (FS-32 lesson)
image = Image.new('RGB', (1400, 760), '#f5f5f0')
draw = ImageDraw.Draw(image)
header(draw, 1400, 'MQTTX sudah menampilkan JSON dari ESP32', 'Host = IPv4 PC · Port 1883. Jendela Mosquitto tetap terbuka.')
...
text(draw, 240, 300, 'FS34 telemetry LAN', 18, '#14532d')
text(draw, 240, 340, 'tersambung', 18, '#166534')
box(draw, (430, 145, 1350, 630), '#ffffff', '#e5e7eb', 0)
text(draw, 890, 185, 'Host  192.168.1.23', 28, '#166534')
text(draw, 890, 230, 'Port  1883', 28, '#166534')
text(draw, 890, 275, 'kodingindonesia/fsiot/esp32-meja-01/telemetry', 16, '#334155')
box(draw, (470, 310, 1310, 490), '#ecfdf5', '#34d399', 4)
text(draw, 890, 345, '{"device_id":"esp32-meja-01",', 20, '#14532d')
text(draw, 890, 385, '"temperature_c":27.4,', 20, '#14532d')
text(draw, 890, 425, '"humidity_pct":63.1}', 20, '#14532d')
text(draw, 890, 465, 'pesan baru kira-kira tiap 5 detik', 16, '#166534')
box(draw, (560, 515, 1220, 595), '#e8f5e9', '#2e7d32', 4)
text(draw, 890, 540, 'Isi Host IPv4 PC dari ipconfig.', 18, '#14532d')
text(draw, 890, 575, '192.168.1.23 hanya contoh.', 18, '#166534')
text(draw, 700, 700, 'Ilustrasi MQTTX buatan Koding Indonesia (FS-34), meniru tata letak aplikasi resmi EMQ. 192.168.1.23 hanya contoh.', 16, '#353535')
save(image, 'fs34-mqttx-json.png')
