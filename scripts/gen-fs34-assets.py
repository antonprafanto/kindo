...
image = Image.new('RGB', (1400, 760), '#f5f5f0')
draw = ImageDraw.Draw(image)
header(draw, 1400, 'Ini tampilan yang benar — JSON hidup di MQTTX', 'Host = IPv4 PC, bukan 127.0.0.1. Bukan layar error.')
...
text(draw, 280, 260, 'FS34 telemetry LAN', 18, '#ecfdf5')
...
text(draw, 890, 280, 'kodingindonesia/fsiot/esp32-meja-01/telemetry', 16, '#334155')
box(draw, (470, 315, 1310, 500), '#ecfdf5', '#34d399', 4)
text(draw, 890, 350, '{"device_id":"esp32-meja-01",', 20, '#14532d')
text(draw, 890, 390, '"temperature_c":27.4,', 20, '#14532d')
text(draw, 890, 430, '"humidity_pct":63.1}', 20, '#14532d')
text(draw, 890, 475, 'pesan baru kira-kira tiap 5 detik', 16, '#166534')
box(draw, (560, 525, 1220, 595), '#e8f5e9', '#2e7d32', 4)
text(draw, 890, 560, 'Bukan broker publik. Bukan localhost.', 20, '#14532d')
