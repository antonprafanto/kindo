...
/**
 * PHP / pedagogi audit #59 — extract & run language-php blocks.
...
$dir = sys_get_temp_dir().DIRECTORY_SEPARATOR.'kindo_a59php_'.bin2hex(random_bytes(4));
mkdir($dir);
...
check(str_contains($demoOut, '422') || str_contains($demoOut, 'OK') || str_contains($demoOut, 'Judul') || str_contains($demoOut, 'slip'), 'run demo output berguna');
