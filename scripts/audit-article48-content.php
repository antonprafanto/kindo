...
check(! preg_match('/(?<![\w\/"#>])#(?:5[0-9]|[6-9]\d)(?!\s*\(ini\))/', $plain), 'Tidak ada plain #50+ di luar link/pre');
...
check(str_contains($body, '/artikel/capstone-sistem-perpustakaan-mini-oop-python'), 'Hardlink #49 Capstone');
