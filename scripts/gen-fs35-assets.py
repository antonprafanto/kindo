...
draw = ImageDraw.Draw(image)
header(draw, 1400, 'MQTTX sudah siap mengirim perintah ke ESP32', 'Host = IPv4 PC · Port 1883. Subscribe status dulu.')
...
image = Image.new('RGB', (1400, 760), '#f5f5f0')
draw = ImageDraw.Draw(image)
header(draw, 1400, 'Klik ikon tiga buku di Arduino IDE 2', 'Cari ArduinoMqttClient, lalu ArduinoJson.')
...
text(draw, 940, 490, 'Ketik ArduinoMqttClient, lalu INSTALL.', 20, '#14532d')
