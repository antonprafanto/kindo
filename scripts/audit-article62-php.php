...
/**
 * PHP / pedagogi audit #62 — extract & run language-php blocks.
...
$dir = sys_get_temp_dir().DIRECTORY_SEPARATOR.'kindo_a62php_'.bin2hex(random_bytes(4));
mkdir($dir);
...
check(str_contains($demoOut, 'Login') || str_contains($demoOut, 'Buku') || str_contains($demoOut, '401') || str_contains($demoOut, 'Belum diizinkan'), 'run demo output berguna');
