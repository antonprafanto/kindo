...
check(str_contains($body54, '5/8 menuju Capstone Laravel'), '#54 Progress 5/8');
...
check(str_contains($deploy, 'oop55phpArrow') && str_contains($deploy, '5/8 menuju Capstone Laravel'), 'Hook body locks');
