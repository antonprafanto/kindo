...
/**
 * Local QA renderer for Article78 (FS-08).
 * Run: php scripts/render-article78-preview.php
 */
...
$html = "<!DOCTYPE html><html lang=\"id\"><head><meta charset=\"utf-8\">".
    ...
    "<title>QA #78 FS-08</title><style>{$css}</style></head><body>".
    "<div class=\"tabs\"><button data-t=\"id\" class=\"active\">Bahasa Indonesia</button>".
    "<button data-t=\"en\">English</button></div>".
    "<div class=\"wrap\">".
    "<section id=\"id\" class=\"lang active\"><h1>Listrik mini untuk awam (ID)</h1>{$idHtml}</section>".
    "<section id=\"en\" class=\"lang\"><h1>Mini electricity for beginners (EN)</h1>{$enHtml}</section>".
    "</div>".
...
file_put_contents(__DIR__.'/../public/_qa78.html', $html);
echo "Wrote public/_qa78.html (".strlen($html)." bytes)".PHP_EOL;
