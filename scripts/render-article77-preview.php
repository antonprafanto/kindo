...
/**
 * Local QA renderer for Article77 (FS-07).
 * Run: php scripts/render-article77-preview.php
 */
...
$html = "<!DOCTYPE html><html lang=\"id\"><head><meta charset=\"utf-8\">".
    ...
    "<title>QA #77 FS-07</title><style>{$css}</style></head><body>".
    "<div class=\"tabs\"><button data-t=\"id\" class=\"active\">Bahasa Indonesia</button>".
    "<button data-t=\"en\">English</button></div>".
    "<div class=\"wrap\">".
    "<section id=\"id\" class=\"lang active\"><h1>Multimeter untuk orang awam (ID)</h1>{$idHtml}</section>".
    "<section id=\"en\" class=\"lang\"><h1>Multimeter for beginners (EN)</h1>{$enHtml}</section>".
    "</div>".
...
file_put_contents(__DIR__.'/../public/_qa77.html', $html);
echo "Wrote public/_qa77.html (".strlen($html)." bytes)".PHP_EOL;
