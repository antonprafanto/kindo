...
check(str_contains($body, '/artikel/mengenal-oop-cara-berpikir-dengan-objek-php'), 'Hardlink teaser Seri 4 #53 OOP PHP');
check(! str_contains($body, '/artikel/http-rest-kontrak-stub-flask-oop'), 'Tidak hardlink slug #53 Flask-era');
