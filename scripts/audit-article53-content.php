...
check(str_contains($body, '8/8 Capstone Laravel selesai'), 'Progress LIVE 5/8');
...
check(str_contains($body, '/artikel/oop-php-property-method-constructor'), 'Hardlink teaser #54 LIVE');
