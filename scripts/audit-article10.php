...
check($seri2IndexCount === 18, 'Indeks Seri 2 punya 18 artikel live (' . $seri2IndexCount . ')');
check(str_contains($body, 'delapan belas artikel'), 'Teks indeks: delapan belas artikel');
...
check(str_contains($body, '#28') || str_contains($body, 'Gateway LoRa'), 'Teaser Seri 2: Gateway LoRa #28');
