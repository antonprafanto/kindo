...
draw = ImageDraw.Draw(image)
header(draw, 1400, 'MQTTX sudah tersambung ke komputer ini', 'Host 127.0.0.1 · Port 1883. Jendela Mosquitto tetap terbuka.')
...
box(draw, (80, 270, 400, 390), '#ecfdf5', '#34d399', 4)
text(draw, 240, 305, 'FS33 broker lokal', 18, '#14532d')
text(draw, 240, 345, 'tersambung', 18, '#166534')
box(draw, (430, 150, 1350, 620), '#ffffff', '#e5e7eb', 0)
text(draw, 890, 250, 'Host  127.0.0.1', 32, '#166534')
text(draw, 890, 310, 'Port  1883', 32, '#166534')
box(draw, (560, 370, 1220, 490), '#e8f5e9', '#2e7d32', 4)
text(draw, 890, 410, 'Isi Host 127.0.0.1 setelah 1883 terlihat.', 18, '#14532d')
text(draw, 890, 450, 'Username dan sandi dikosongkan.', 18, '#166534')
