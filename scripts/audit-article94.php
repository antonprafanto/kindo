...
check('no helper DHT breadboard in #94', ! str_contains($id, 'fs21-dht22-breadboard.png') && ! str_contains($en, 'fs21-dht22-breadboard.png'));
check('no helper relay breadboard in #94', ! str_contains($id, 'fs23-relay-breadboard.png') && ! str_contains($en, 'fs23-relay-breadboard.png'));
...
check('no Acuan fisik helpers ID', ! str_contains($id, 'Acuan fisik'));
check('no Physical reference helpers EN', ! str_contains($en, 'Physical DHT22 reference') && ! str_contains($en, 'Physical relay reference'));
